...
class TestCreateOrder:
    ...
    @allure.title('Возможно создать заказ, если пользователь авторизован')
    ...
    @allure.title('Невозможно создать заказ, не добавив ни одного ингредиента')
    ...
    @allure.title('Невозможно создать заказ, если передан невалидный хэш ингреденитов')
