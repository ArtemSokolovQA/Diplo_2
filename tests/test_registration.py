...
class TestRegistration:
    ...
    @allure.title('Проверка возможности зарегистрироваться с валидными данными')
    ...
    @allure.title('Попытка зарегистрировать уже существующего в БД юзера')
    ...
    @allure.title('Проверка ошибки, если не заполнено обязательное поле password при регистрации пользователя')
